...
/***/ function(module, exports) {
	...
	module.exports = {
	    data: function () {return {
	        bgImgSrc: "/imgs/background/greetingBg2.png",
	        startBtn: "/imgs/startClick.png",
	      ...
	      "children": [
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.default($event)}
	          }
	        },
	        {
	          "type": "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  methods: {
	    ...
	    operateCard: function operateCard(event) {
	      var cardNum = event.target.attr.num;
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        startPunish: function startPunish() {
	            this._parent.$emit("startPunish", { selectedPlayer: this.select_player });
	        }
	    }
	};}
	/* generated by weex-loader */
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.failedPlayer}
	                  }
	                }
	              ]
	            },
...
/***/ function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        doSelect: function doSelect(e) {
	            this.failedPlayer = e.target.attr.value;
	        },
	        startPunish: function startPunish() {
...
/***/ function(module, exports) {
	...
	module.exports = {
	    data: function () {return {
	        bgImgSrc: "/imgs/background/scoreBg.png",
