	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        storeToBag: function storeToBag() {
	            if (this.currPlayerId < 6) {
	                this.leftPlayer[this.currPlayerId - 1].bag.push(this.currCardNum);
	            } else if (this.currPlayerId < 11) {
	                    this.rightPlayer[this.currPlayerId - 6].bag.push(this.currCardNum);
	                }
